...
<body>
	...
	<form action="updateVacation.do" method="POST">
			...
			<label for="title">*Vacation Name : </label><input type="text" name="title" value="${sessionVacation.title}" required><br> 			
			
			<label for="title">Description : </label><input type="text" name="description" value="${sessionVacation.description}" ><br> 
			
			<label for="title">Image URL : </label><input type="text" name="imageUrl" value="${sessionVacation.imageUrl}"> <br> 
